        ...
        try {
             ...
             SwingUtilities.invokeLater(new Runnable() {
                 public void run() {
                    ...
                    if (true || MainFrame.getMainInstance().getProperties().getProperty( "enableRMIServer" ,"false").equals("true") ||
...
//        }
  ...
  */
    ...
    public static void main(String args[]) {
        ...
        Object remoteFile = AddedOperator.getInstance().openRemoteFile();
        if(remoteFile!=null){
                    ...
                    if (children != null) {
                        for (int k=0; k< children.getLength(); k++) {
                            ...
                            if (nodeChild.getNodeType() == Node.ELEMENT_NODE && nodeChild.getNodeName().equals("IconFile")) {
                                ...
                                try {
                                    pe.setIcon( new javax.swing.ImageIcon(getClass().getResource(iconName) ));
