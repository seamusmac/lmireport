...
public class ClassMethodDialog extends javax.swing.JDialog {
	...
	public AddCollection jbeditor = null;

	public ClassMethodDialog(AddCollection je,
	...
	private void initComponents() {
		...
		jLabel2.setText(jbeditor.jTextField2.getText());
	...
	private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {
		...
		if(!IreportUtil.isBlank(method)){
			jbeditor.jTextField3.setText(method);
		}else{
	...
	private void initJList() {
		try {
			...
			String classname = jbeditor.jTextField2.getText();
